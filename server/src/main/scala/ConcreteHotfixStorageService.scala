...
object DummyHotfixSource {
  val edits: List[GeocodeServingFeatureEdit] = List(
    GeocodeServingFeatureEdit.newBuilder
      ...
      .longId(7650L)
      .wktGeometry("POLYGON((-73.97759914398193 40.752036129031076,-73.98133277893066 40.74719193776603,-73.97176265716553 40.743030203074504,-73.9678144454956 40.748069770416734,-73.97759914398193 40.752036129031076))")
      .namesEdits(List(
        FeatureNameListEdit(
          EditType.Add,
          "Curry Hill",
